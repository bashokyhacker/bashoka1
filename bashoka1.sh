...
# Modified by: github.com/bashokyhacker/bashoka1 'printf "\n";stop' 2
...
printf "\e[1;77m Website :- not now hahah \e[0m \n"
printf "\e[1;77m v2.0 Coded By github.com/bashokyhacker \e[0m \n"
